    ...
    return (
        <div className="card index-card album">
            ...
            <div className="card-body">
                <h5 className="card-title"><NavLink to={`/albums?albumSlug=${props.albumSlug}`}>{`${props.title} (${props.year})`}</NavLink></h5>
                <hr />
    ...
    */
    return (
        <div className="card index-card genre">
            <div className="top">
                <img className="card-img-top" alt={`cover for ${props.genreName}`} src={props.cover}/>
            </div>
            <div className="card-body">
                <h5 className="card-title"><NavLink to={`/genres?genreName=${props.genreSlug}`}>{props.genreName}</NavLink></h5>
                <hr />
                <div className="card-text">
                    <div className="play-par">
                        <span><img className="play-btn" src="http://127.0.0.1:8000/static/svg/play-circle.svg" alt="play button"/></span>
